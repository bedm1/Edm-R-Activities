...
```{r}
#data is in /Users/Bal_1/Documents/R Activities/Inputs`
#use library readr function
library(readr)
...
#use library readr function
library(readr)
fev_data <- read_csv("fev.csv",col_names = TRUE,show_col_types = FALSE)
